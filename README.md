...
# 3VMs: Debian 12 8gb de ram 2 proc

# Score card installer analyse du repo 
# OpenSSF Scorecard
...
Mem:           7.8Gi       1.7Gi       631Mi        19Mi       5.7Gi       6.1Gi
Swap:          975Mi          0B       975Mi
Filesystem      Size  Used Avail Use% Mounted on
/dev/sda1        30G   10G   19G  36% /
Architecture:                         x86_64
...
System:
  Kernel: 6.1.0-31-amd64 arch: x86_64 bits: 64 compiler: gcc v: 12.2.0 Console: pty pts/4
    Distro: Debian GNU/Linux 12 (bookworm)
Machine:
  Type: Virtualbox System: innotek GmbH product: VirtualBox v: 1.2 serial: <filter>
...
Battery:
  ID-1: BAT0 charge: 50.0 Wh (100.0%) condition: 50.0/50.0 Wh (100.0%) volts: 10.0 min: 10.0
    model: innotek 1 status: full
CPU:
  Info: dual core model: 12th Gen Intel Core i5-12450H bits: 64 type: MCP arch: Alder Lake rev: 3
    cache: L1: 160 KiB L2: 2.5 MiB L3: 24 MiB
...
Graphics:
  ...
  Display: server: X.org v: 1.21.1.7 with: Xwayland v: 22.1.9 driver: gpu: vmwgfx
    note: X driver n/a tty: 120x30
...
Network:
  ...
  Device-2: Intel 82371AB/EB/MB PIIX4 ACPI type: network bridge driver: piix4_smbus v: N/A
    port: N/A bus-ID: 00:07.0
Drives:
  Local Storage: total: 31.4 GiB used: 6.36 GiB (20.3%)
  ID-1: /dev/sda vendor: VirtualBox model: VBOX HARDDISK size: 31.4 GiB
Partition:
  ID-1: / size: 29.8 GiB used: 6.36 GiB (21.3%) fs: ext4 dev: /dev/sda1
Swap:
...
Info:
  Processes: 189 Uptime: 2h 5m Memory: 7.76 GiB used: 1.6 GiB (20.6%) Init: systemd
  target: graphical (5) Compilers: N/A Packages: 1613 Shell: Bash v: 5.2.15 inxi: 3.3.26
